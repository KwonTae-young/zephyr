...
#include <LoRaMac.h>
	...
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_AS923
#elif CONFIG_LORAMAC_REGION_AU915
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_AU915
#elif CONFIG_LORAMAC_REGION_CN470
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_CN470
#elif CONFIG_LORAMAC_REGION_CN779
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_CN779
#elif CONFIG_LORAMAC_REGION_EU433
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_EU433
#elif CONFIG_LORAMAC_REGION_EU868
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_EU868
#elif CONFIG_LORAMAC_REGION_KR920
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_KR920
#elif CONFIG_LORAMAC_REGION_IN865
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_IN865
#elif CONFIG_LORAMAC_REGION_US915
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_US915
#elif CONFIG_LORAMAC_REGION_RU864
	#define CONFIG_LORAWAN_REGION CONFIG_LORAMAC_REGION_RU864
#elif
...
static void McpsIndication(McpsIndication_t *mcpsIndication)
{
	...
	if (mcpsIndication->RxData == true) {
		if (mcpsIndication->BufferSize != 0) {
			LOG_INF("Rx Data: %s", log_strdup(mcpsIndication->Buffer));
		}
	}
...
/*
	...
	mibReq.Param.ChannelsTxPower = mib_config->tx_power;
	LoRaMacMibSetRequestConfirm(&mibReq);

	mibReq.Type = MIB_CHANNELS_DEFAULT_DATARATE;
	mibReq.Param.ChannelsDatarate = mib_config->tx_datarate;
	LoRaMacMibSetRequestConfirm(&mibReq);
...
*/
	...
	mibReq.Param.Rx2Channel.Frequency = mib_config->rx2_freq;
	mibReq.Param.Rx2Channel.Datarate = mib_config->rx2_datarate;
	LoRaMacMibSetRequestConfirm(&mibReq);
...
static int lorawan_init(struct device *dev)
{
	...
	LoRaMacInitialization(&macPrimitives, &macCallbacks,
...
SYS_INIT(lorawan_init, POST_KERNEL, CONFIG_KERNEL_INIT_PRIORITY_DEVICE);
